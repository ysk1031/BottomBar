...
public class MiscUtils {
    ...
    /**
     * @param fontPath the path in which the {@link Typeface} is found
     * @return the {@link Typeface} found in the {@code fontPath}, or NULL if something went wrong
     */
    @Nullable
    protected static Typeface getTypeFaceFromAsset(@NonNull Context context, @Nullable String fontPath) {
        if (fontPath != null) {
